    ...
    \begin{longtable}{p{0.2\textwidth}  p{0.7\textwidth}}
     Sep.  2022 --    present & \textbf{Director}. \textit{Mason Experimental Geometry Lab (MEGL)}.  \\ 
...
6 Jan.  2023 & \textbf{Recruiter and GMU Representative}. \textit{Joint Mathematics Meetings Graduate Fair}. 
        ...
        \begin{itemize}
        \setlength{\parindent}{0em}
        \item[] Advertised the mathematics graduate program at George Mason to prospective students.
        \end{itemize}
        }
        \vspace{-1em}
         \\ 
...
16 Jan.  2019 & \textbf{Panelist}. \textit{Joint Mathematics Meetings}.  Association for Women in Mathematics Panel: Promoting Inclusion in Stem.  
    ...
    \renewcommand{\arraystretch}{1.2}
    \begin{longtable}{p{0.2\textwidth}  p{0.7\textwidth}}
    3 Dec.  2023 & \textbf{Activity Facilitator}. \textit{Mason Early Identification STEM Fusion program}.  Making Mathematics Meaningful. 
        \hspace{-1em}
